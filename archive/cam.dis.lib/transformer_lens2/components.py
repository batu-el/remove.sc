...
from transformer_lens2.hook_points import HookPoint
from transformer_lens2.HookedTransformerConfig import HookedTransformerConfig
from transformer_lens2.past_key_value_caching import HookedTransformerKeyValueCacheEntry
...
class BertMLMHead(nn.Module):
    ...
    def __init__(self, cfg: Union[Dict, HookedTransformerConfig]):
        ...
        self.act_fn = lambda x: torch.tanh(x)
        # self.ln = LayerNorm(cfg)
